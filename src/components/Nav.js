...
<nav className='blue darken-1 col l12 s12'>
	<div className = 'nav-wrapper blue darken-4' id='nav'>
    	<h4 className="brand logo blue darken-4 white text">Jason's Restaurant</h4>
     	<ul className="right hide-on-med-and-down">
      		<li className="active"><a className= "blue darken-4 white-text" href="order.html">Order Delivery</a></li>
    	 </ul>
    	<ul className="side-nav blue darken-4">
